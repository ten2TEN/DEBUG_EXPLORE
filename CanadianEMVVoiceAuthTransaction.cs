...
{
	public class CanadianEMVVoiceAuthTransaction : CanadianEMVTransaction
	{
		...
		public CanadianEMVVoiceAuthTransaction()
		{
		...
		protected override void SetValues()
		{
			...
			{
				base.SetValues();
				base.DSIEmvTransaction.TranCode = DSIEMVTransaction.eEMVTranCode.EMVVoiceAuth.ToString();
