...
namespace Newtonsoft.Json.Schema
{
	internal static class JsonSchemaConstants
	{
		...
		public readonly static IDictionary<string, JsonSchemaType> JsonSchemaTypeMapping;

		static JsonSchemaConstants()
		{
			Dictionary<string, JsonSchemaType> strs = new Dictionary<string, JsonSchemaType>()
			{
			...
			JsonSchemaConstants.JsonSchemaTypeMapping = strs;
		}
	}
}