...
{
	public class CanadianEMVVoidReturnTransaction : CanadianEMVTransaction
	{
		...
		public CanadianEMVVoidReturnTransaction()
		{
		...
		protected override void SetValues()
		{
			...
			{
				base.SetValues();
				base.DSIEmvTransaction.TranCode = DSIEMVTransaction.eEMVTranCode.EMVVoidReturn.ToString();
