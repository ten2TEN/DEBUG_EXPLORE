...
namespace Twitterizer.Commands
{
	...
	{
		public FriendsIdsCommand(OAuthTokens requestTokens, UsersIdsOptions options) : base(HTTPVerb.GET, string.Format(CultureInfo.CurrentCulture, "friends/ids.json", new object[0]), requestTokens, options)
		{
