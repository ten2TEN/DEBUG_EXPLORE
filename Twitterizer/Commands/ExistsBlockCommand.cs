...
namespace Twitterizer.Commands
{
	internal class ExistsBlockCommand : TwitterCommand<TwitterUser>
	{
		...
		public ExistsBlockCommand(OAuthTokens tokens, string screenName, decimal userId, Twitterizer.OptionalProperties options) : base(HTTPVerb.GET, "blocks/exists.json", tokens, options)
		{
