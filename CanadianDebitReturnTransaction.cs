...
{
	public class CanadianDebitReturnTransaction : Transaction
	{
		...
		public CanadianDebitReturnTransaction()
		{
			this._pinPadConfig = new Transaction.PinPadConfig();
			this._amountData = new Transaction.AmountData();
		}

		public CanadianDebitReturnTransaction(Transaction.PinPadConfig pinPadConfig, Transaction.AmountData amountData)
		{
