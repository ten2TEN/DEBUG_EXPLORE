...
{
	public class CanadianDebitPadResetTransaction : Transaction
	{
		...
		public CanadianDebitPadResetTransaction()
		{
			this._pinPadConfig = new Transaction.PinPadConfig();
		}

		public CanadianDebitPadResetTransaction(Transaction.PinPadConfig pinPadConfig)
		{
		...
		protected override void SetValues()
		{
			...
			base.dsiTransaction.TranCode = "PadReset";
