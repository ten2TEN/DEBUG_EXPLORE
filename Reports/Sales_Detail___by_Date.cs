...
namespace Reports
{
	public class Sales_Detail___by_Date : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x6cce);
				return str;
			}
			set
			{
		...
		public IParameterField Parameter_Company_Name
		{
			get
			{
				return this.get_DataDefinition().get_ParameterFields().get_Item(2);
			}
		}
		...
		public IParameterField Parameter_End_Date
		{
			get
			{
				...
				ParameterFieldDefinition item = dataDefinition.get_ParameterFields().get_Item(1);
				return item;
			}
		}
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x6c99);
				return str;
			}
			set
			{
