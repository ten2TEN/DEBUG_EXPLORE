...
namespace Reports
{
	public class service_sales_count_comparison___by_yeartable : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x7d00);
				return str;
			}
			set
			{
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x7c99);
				return str;
			}
			set
			{
		...
		public service_sales_count_comparison___by_yeartable()
		{
		}
	}
}