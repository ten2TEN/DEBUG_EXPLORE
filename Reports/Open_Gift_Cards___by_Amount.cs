...
namespace Reports
{
	public class Open_Gift_Cards___by_Amount : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x4b84);
				return str;
			}
			set
			{
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Ending_Value
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Starting_Value
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x4b45);
				return str;
			}
			set
			{
		...
		public Open_Gift_Cards___by_Amount()
		{
		}
	}
}