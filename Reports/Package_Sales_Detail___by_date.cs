...
namespace Reports
{
	public class Package_Sales_Detail___by_date : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x54a2);
				return str;
			}
			set
			{
		...
		public Section GroupFooterSection1
		{
			get
			{
				...
				return reportDefinition.get_Sections().get_Item(8);
			}
		}
		...
		public Section GroupHeaderSection3
		{
			get
			{
				Section item = this.get_ReportDefinition().get_Sections().get_Item(4);
				return item;
			}
		}
		...
		public Section PageHeaderSection1
		{
			get
			{
				Section item = this.get_ReportDefinition().get_Sections().get_Item(1);
				return item;
			}
		}
		...
		public Section ReportFooterSection1
		{
			...
			{
				ReportDefinition reportDefinition = this.get_ReportDefinition();
				Section item = reportDefinition.get_Sections().get_Item(9);
				return item;
			}
		}
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x545d);
				return str;
			}
			set
			{
		...
		public Package_Sales_Detail___by_date()
		{
		}
	}
}