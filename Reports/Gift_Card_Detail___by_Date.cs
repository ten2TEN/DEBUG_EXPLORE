...
namespace Reports
{
	public class Gift_Card_Detail___by_Date : ReportClass
	{
		[Browsable(false)]
		...
		public Section DetailSection1
		{
			get
			{
				...
				return reportDefinition.get_Sections().get_Item(3);
			}
		}
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x37ee);
				return str;
			}
			set
			{
		...
		public Section GroupFooterSection1
		{
			...
			{
				ReportDefinition reportDefinition = this.get_ReportDefinition();
				Section item = reportDefinition.get_Sections().get_Item(4);
				return item;
			}
		}
		...
		public IParameterField Parameter_End_Date
		{
			...
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
				return dataDefinition.get_ParameterFields().get_Item(1);
			}
		}

		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_GiftCard_ID
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_GiftCard_Initial_Amount
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_GiftCard_Serial_Number
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Loc_Num
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
				ParameterFieldDefinitions parameterFields = dataDefinition.get_ParameterFields();
				return parameterFields.get_Item(6);
			}
		}
		...
		public IParameterField Parameter_Start_Date
		{
			get
			{
				ParameterFieldDefinition item = this.get_DataDefinition().get_ParameterFields().get_Item(0);
				return item;
			}
		}
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x37b1);
				return str;
			}
			set
			{
		...
		public Gift_Card_Detail___by_Date()
		{
		}
	}
}