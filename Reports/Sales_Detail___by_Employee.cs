...
namespace Reports
{
	public class Sales_Detail___by_Employee : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x6d50);
				return str;
			}
			set
			{
		...
		public IParameterField Parameter_Employee_ID
		{
			...
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
				ParameterFieldDefinition item = dataDefinition.get_ParameterFields().get_Item(7);
				return item;
			}
		}
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x6d13);
				return str;
			}
			set
			{
		...
		public Sales_Detail___by_Employee()
		{
		}
	}
}