...
namespace Reports
{
	public class Package_Sales_Count_Projection___by_Month : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x53f2);
				return str;
			}
			set
			{
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x5397);
				return str;
			}
			set
			{
		...
		public Package_Sales_Count_Projection___by_Month()
		{
		}
	}
}