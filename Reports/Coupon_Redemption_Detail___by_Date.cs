...
namespace Reports
{
	public class Coupon_Redemption_Detail___by_Date : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x201c);
				return str;
			}
			set
			{
		...
		public Section PageFooterSection1
		{
			...
			{
				ReportDefinition reportDefinition = this.get_ReportDefinition();
				return reportDefinition.get_Sections().get_Item(12);
			}
		}
		...
		public Section ReportFooterSection1
		{
			...
			{
				ReportDefinition reportDefinition = this.get_ReportDefinition();
				Section item = reportDefinition.get_Sections().get_Item(11);
				return item;
			}
		}
		...
		public override string ResourceName
		{
			get
			{
				return c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x1fcf);
			}
			set
			{
			}
		...
		public Coupon_Redemption_Detail___by_Date()
		{
		}
	}
}