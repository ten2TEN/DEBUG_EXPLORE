...
namespace Reports
{
	public class Client_Purchases___by_Client : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				return c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x94f);
			}
			set
			{
			}
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Begin_Date
		{
			get
			{
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Client_Name
		{
			get
			{
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_ClientID
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_CompanyName
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Tax_1_Name
		{
			get
			{
				ParameterFieldDefinitions parameterFields = this.get_DataDefinition().get_ParameterFields();
				ParameterFieldDefinition item = parameterFields.get_Item(6);
				return item;
			}
		}
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Tax_2_Name
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
				ParameterFieldDefinitions parameterFields = dataDefinition.get_ParameterFields();
				ParameterFieldDefinition item = parameterFields.get_Item(7);
				return item;
			}
		}
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Tax_3_Name
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
				return dataDefinition.get_ParameterFields().get_Item(8);
			}
		}
		...
		public Section ReportFooterSection1
		{
			...
			{
				ReportDefinition reportDefinition = this.get_ReportDefinition();
				Section item = reportDefinition.get_Sections().get_Item(7);
				return item;
			}
		}
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x90e);
				return str;
			}
			set
			{
		...
		public Client_Purchases___by_Client()
		{
		}
	}
}