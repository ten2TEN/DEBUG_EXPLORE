...
namespace Reports
{
	public class Inventory_Worksheet___by_Category : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x4356);
				return str;
			}
			set
			{
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x430b);
				return str;
			}
			set
			{
		...
		public Inventory_Worksheet___by_Category()
		{
		}
	}
}