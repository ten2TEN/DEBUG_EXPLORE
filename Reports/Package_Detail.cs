...
namespace Reports
{
	public class Package_Detail : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x4c92);
				return str;
			}
			set
			{
		...
		public IParameterField Parameter_Tax_2_Amount
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
				ParameterFieldDefinitions parameterFields = dataDefinition.get_ParameterFields();
				ParameterFieldDefinition item = parameterFields.get_Item(8);
				return item;
			}
		}
		...
		public IParameterField Parameter_Tax_3_Amount
		{
			...
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
				ParameterFieldDefinition item = dataDefinition.get_ParameterFields().get_Item(9);
				return item;
			}
		}
		...
		public override string ResourceName
		{
			get
			{
				return c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x4c6d);
			}
			set
			{
			}
