...
namespace Reports
{
	public class Client_Labels_by_Age_5160 : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0xcc9);
				return str;
			}
			set
			{
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Company_Country
		{
			get
			{
				ParameterFieldDefinition item = this.get_DataDefinition().get_ParameterFields().get_Item(4);
				return item;
			}
		}
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Max_Age
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Min_Age
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
		...
		public Section ReportFooterSection1
		{
			...
			{
				ReportDefinition reportDefinition = this.get_ReportDefinition();
				return reportDefinition.get_Sections().get_Item(7);
			}
		}
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0xc8e);
				return str;
			}
			set
			{
		...
		public Client_Labels_by_Age_5160()
		{
		}
	}
}