...
namespace Reports
{
	public class Future_EFT_Drafts___by_Month : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				return c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x3760);
			}
			set
			{
			}
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Number_Of_Years
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Starting_Year
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x371f);
				return str;
			}
			set
			{
		...
		public Future_EFT_Drafts___by_Month()
		{
		}
	}
}