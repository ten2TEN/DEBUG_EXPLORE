...
namespace Reports
{
	public class Coupon_Transaction_History___by_Date : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x2284);
				return str;
			}
			set
			{
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Coupon_ID
		{
			get
			{
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Coupon_Name
		{
			get
			{
				ParameterFieldDefinitions parameterFields = this.get_DataDefinition().get_ParameterFields();
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x2233);
				return str;
			}
			set
			{
		...
		public Coupon_Transaction_History___by_Date()
		{
		}
	}
}