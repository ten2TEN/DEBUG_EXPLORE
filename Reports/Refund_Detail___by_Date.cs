...
namespace Reports
{
	public class Refund_Detail___by_Date : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x67ca);
				return str;
			}
			set
			{
		...
		public Section ReportFooterSection1
		{
			get
			{
				Section item = this.get_ReportDefinition().get_Sections().get_Item(9);
				return item;
			}
		}
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x6793);
				return str;
			}
			set
			{
		...
		public Refund_Detail___by_Date()
		{
		}
	}
}