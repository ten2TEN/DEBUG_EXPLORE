...
namespace Reports
{
	public class EFT_Draft_Sales_Count_Comparison___by_MonthTable : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x2ae8);
				return str;
			}
			set
			{
		...
		public override string ResourceName
		{
			get
			{
				return c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x2a7b);
			}
			set
			{
			}
		...
		public EFT_Draft_Sales_Count_Comparison___by_MonthTable()
		{
		}
	}
}