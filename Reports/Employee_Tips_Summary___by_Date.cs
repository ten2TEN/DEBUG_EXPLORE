...
namespace Reports
{
	public class Employee_Tips_Summary___by_Date : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x3456);
				return str;
			}
			set
			{
		...
		public Section GroupFooterSection1
		{
			get
			{
				...
				return reportDefinition.get_Sections().get_Item(10);
			}
		}
		...
		public Section ReportFooterSection1
		{
			...
			{
				ReportDefinition reportDefinition = this.get_ReportDefinition();
				Section item = reportDefinition.get_Sections().get_Item(13);
				return item;
			}
		}
		...
		public override string ResourceName
		{
			get
			{
				return c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x340f);
			}
			set
			{
			}
		...
		public Employee_Tips_Summary___by_Date()
		{
		}
	}
}