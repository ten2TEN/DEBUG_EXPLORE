...
namespace Reports
{
	public class Employee_Sales_Average___by_Date : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				return c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x30b0);
			}
			set
			{
			}
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Request_Store
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x3067);
				return str;
			}
			set
			{
		...
		public Employee_Sales_Average___by_Date()
		{
		}
	}
}