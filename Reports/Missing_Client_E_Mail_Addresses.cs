...
namespace Reports
{
	public class Missing_Client_E_Mail_Addresses : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x482a);
				return str;
			}
			set
			{
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x47e3);
				return str;
			}
			set
			{
		...
		public Missing_Client_E_Mail_Addresses()
		{
		}
	}
}