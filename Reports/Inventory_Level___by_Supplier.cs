...
namespace Reports
{
	public class Inventory_Level___by_Supplier : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x4152);
				return str;
			}
			set
			{
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x410f);
				return str;
			}
			set
			{
		...
		public Inventory_Level___by_Supplier()
		{
		}
	}
}