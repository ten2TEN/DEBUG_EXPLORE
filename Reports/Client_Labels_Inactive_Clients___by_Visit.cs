...
namespace Reports
{
	public class Client_Labels_Inactive_Clients___by_Visit : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				return c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x1023);
			}
			set
			{
			}
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Country
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
		...
		public Section ReportHeaderSection1
		{
			...
			{
				ReportDefinition reportDefinition = this.get_ReportDefinition();
				Section item = reportDefinition.get_Sections().get_Item(0);
				return item;
			}
		}
		...
		public override string ResourceName
		{
			get
			{
				return c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0xfc8);
			}
			set
			{
			}
		...
		public Client_Labels_Inactive_Clients___by_Visit()
		{
		}
	}
}