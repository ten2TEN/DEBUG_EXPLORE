...
namespace Reports
{
	public class Inventory_Worksheet___by_Manufacturer : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x4404);
				return str;
			}
			set
			{
		...
		public IParameterField Parameter_Store_Number
		{
			get
			{
				return this.get_DataDefinition().get_ParameterFields().get_Item(1);
			}
		}
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x43b1);
				return str;
			}
			set
			{
		...
		public Inventory_Worksheet___by_Manufacturer()
		{
		}
	}
}