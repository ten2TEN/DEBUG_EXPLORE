...
namespace Reports
{
	public class eft_draft_count_comparison___by_yeartable : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x2786);
				return str;
			}
			set
			{
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x2727);
				return str;
			}
			set
			{
		...
		public eft_draft_count_comparison___by_yeartable()
		{
		}
	}
}