...
namespace Reports
{
	public class Product_Sales_Detail___by_date : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x63dc);
				return str;
			}
			set
			{
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x6397);
				return str;
			}
			set
			{
		...
		public Product_Sales_Detail___by_date()
		{
		}
	}
}