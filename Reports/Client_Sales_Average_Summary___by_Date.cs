...
namespace Reports
{
	public class Client_Sales_Average_Summary___by_Date : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x18ca);
				return str;
			}
			set
			{
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Include_All_Sales
		{
			get
			{
				return this.get_DataDefinition().get_ParameterFields().get_Item(6);
			}
		}

		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Sales_Detail_Price_High
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
				return dataDefinition.get_ParameterFields().get_Item(4);
			}
		}

		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Sales_Detail_Price_Low
		{
			get
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
				ParameterFieldDefinition item = dataDefinition.get_ParameterFields().get_Item(5);
				return item;
			}
		}
		...
		public IParameterField Parameter_Start_Date
		{
			...
			{
				DataDefinition dataDefinition = this.get_DataDefinition();
				return dataDefinition.get_ParameterFields().get_Item(0);
			}
		}
		...
		public IParameterField Parameter_Store_Number
		{
			get
			{
				ParameterFieldDefinition item = this.get_DataDefinition().get_ParameterFields().get_Item(3);
				return item;
			}
		}
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x1875);
				return str;
			}
			set
			{
		...
		public Client_Sales_Average_Summary___by_Date()
		{
		}
	}
}