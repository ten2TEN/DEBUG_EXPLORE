...
namespace Reports
{
	public class Appointments___by_Room : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x4c1);
				return str;
			}
			set
			{
		...
		public Section GroupFooterSection1
		{
			get
			{
				Section item = this.get_ReportDefinition().get_Sections().get_Item(6);
				return item;
			}
		}
		...
		[Browsable(false)]
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		public IParameterField Parameter_Bed_ID
		{
			get
			{
		...
		public override string ResourceName
		{
			get
			{
				return c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x48c);
			}
			set
			{
			}
