...
namespace Reports
{
	public class Product_Sales_Summary___by_Manufacturer : ReportClass
	{
		[Browsable(false)]
		...
		public override string FullResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x6676);
				return str;
			}
			set
			{
		...
		public IParameterField Parameter_End_Date
		{
			get
			{
				...
				return dataDefinition.get_ParameterFields().get_Item(3);
			}
		}
		...
		public override string ResourceName
		{
			get
			{
				string str = c509d0298614329a40be24aa683d5ad1d.c2a612a176ab45500f820316f6e1b7149(0x661f);
				return str;
			}
			set
			{
		...
		public Product_Sales_Summary___by_Manufacturer()
		{
		}
	}
}